...
if (isset($_POST['save']))
{
  ...
  $koneksi->query("INSERT INTO inovator
    (judul_inovator,foto_inovator, date_i, isi_i)
    VALUES ('$_POST[judul]','$nama', '$_POST[waktu]', '$_POST[isi]')");


  echo "<div class='alert alert-info'>Data Tersimpan</div>";
  echo "<meta http-equiv='refresh' content='1;url=index.php?halaman=inovator'>";
